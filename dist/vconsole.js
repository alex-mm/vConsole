...
/***/ function(module, exports, __webpack_require__) {
	...
	var _legao = __webpack_require__(30);

	var _legao2 = _interopRequireDefault(_legao);
	...
	var legaoTab = new _legao2.default('legao', 'LegaoLog');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _legaobar = __webpack_require__(12);

	var _legaobar2 = _interopRequireDefault(_legaobar);
	  ...
	  _createClass(VConsole, [{
	    ...
	    value: function _initPlugin(plugin) {
	      ...
	      plugin.trigger('addLegaoBar', function (toolList) {
	        ...
	        var $legaoBar = _query2.default.one('.vc-legaobar', that.$dom);
...
/***/ function(module, exports) {
	...
	module.exports = "<a class=\"vc-legao\" data-tab=\"{{id}}\" id=\"__vc_legao_{{id}}\">{{name}}</a>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabbox_legao = __webpack_require__(31);

	var _tabbox_legao2 = _interopRequireDefault(_tabbox_legao);
	...
	var operationData = [{
	  ...
	  name: (0, _util.parseQuery)().__render_log ? 'Close render log' : 'Start render log',
	  onClick: function onClick() {
	    ...
	    var queryString = (0, _util.stringifyQuery)(query);
	    var l = location;
	  ...
	  name: (0, _util.parseQuery)().__render_try ? 'Close render try' : 'Start render try',
	  onClick: function onClick() {
	    var query = (0, _util.parseQuery)();
	...
	var LegaoTab = function (_VConsoleLogTab) {
	  _inherits(LegaoTab, _VConsoleLogTab);

	  function LegaoTab() {
	    var _ref;

	    _classCallCheck(this, LegaoTab);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    var _this = _possibleConstructorReturn(this, (_ref = LegaoTab.__proto__ || Object.getPrototypeOf(LegaoTab)).call.apply(_ref, [this].concat(args)));

	    _this.tplTabbox = _tabbox_legao2.default;
	    return _this;
	  }

	  _createClass(LegaoTab, [{
	    key: 'onAddLegaoBar',
	    value: function onAddLegaoBar(callback) {
	      var btnList = [];
	      operationData.forEach(function (data) {
	        btnList.push({
	          name: data.name,
	          data: {
	  ...
	  return LegaoTab;
	}(_default2.default); // END class

	exports.default = LegaoTab;
	module.exports = exports['default'];
...
/***/ function(module, exports) {
	...
	function parseQuery() {
	  ...
	  s.split('&').forEach(function (param) {
